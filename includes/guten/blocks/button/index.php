...
function block_engine_render_button_block($attributes){
    extract($attributes);
...
function block_engine_button_add_frontend_assets() {
...
function block_engine_register_button_block() {
	if ( function_exists( 'register_block_type' ) ) {
        require dirname(dirname(__DIR__)) . '/defaults.php';
		register_block_type( 'block-engine/button', array(
            'attributes' => $defaultValues['block-engine/button']['attributes'],
			'render_callback' => 'block_engine_render_button_block'));
	}
}

add_action('init', 'block_engine_register_button_block');
